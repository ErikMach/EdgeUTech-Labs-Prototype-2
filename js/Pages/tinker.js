...
const configureTinkerPage = (createBlock) => {
  ...
  const codingSpace = c("div", {class:"codingSpace"}, [
    c("div", {class:"blockSpace"}, [
      c("div", {class:"blockMenuCont"}, Object.keys(codingBlocks).map(t =>
	c("div", {class:"blockMenuItem", id:`${t}Menu`}, [c("div", {class:"blockMenuItemCircle", "style":`background-color:${codingBlocks[t].color}`}), c("a", {textContent: t})])
      )),
      c("div", {class:"blockCont"}, Object.keys(codingBlocks).map(t => {
	return c("div", {class:"blockSet"}, [c("h5", {textContent: t}), ...codingBlocks[t].blocks.map(b => createBlock(b))]);
      })),
