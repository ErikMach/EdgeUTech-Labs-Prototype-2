...
const c = (tagName, attrs = {}, children = []) => {
	const elem = ["svg", "g", "text", "path", "rect", "foreignObject"].includes(tagName)
		? document.createElementNS("http://www.w3.org/2000/svg", tagName)
		: document.createElement(tagName);
	for (let [attr, value] of Object.entries(attrs)) {
		if (attr !== "textContent") {
			// ['d', 'x', 'y', "rx, "ry", "transform", "class"].includes(attr)) {
...
const createSVGSelectMenu = (opts = [], dims = { width: 32, height: 32 }) => {
	const foreignObject = c(
		"foreignObject",
		{ class: "SVGMenu", width: getSVGTextWidthMax(opts), height: 32 },
		[createSelectMenu(opts)]
	);
...
const paths = {
	...
	"command-double": {
		draw: (length = 108) => {
			return `M 0 4 a4,4,0,0,1,4,-4 h 8 c2,0,3,1,4,2 l 4 4 c1,1,2,2,4,2 h 12 c2,0,3,-1,4,-2 l 4 -4 c1,-1,2,-2,4,-2 h ${length} a4,4,0,0,1,4,4 v 40 a4,4,0,0,1,-4,4 h -${
				length - 16
			} c-2,0,-3,1,-4,2 l -4 4 c-1,1,-2,2,-4,2 h -12 c-2,0,-3,-1,-4,-2 l -4 -4 c-1,-1,-2,-2,-4,-2 h -8 a4,4,0,0,0,-4,4 v 16 a4,4,0,0,0,4,4 l 8 0 c2,0,3,1,4,2 l 4 4 c1,1,2,2,4,2 h 12 c2,0,3,-1,4,-2 l 4 -4 c1,-1,2,-2,4,-2 h ${
				length - 16
			} a4,4,0,0,1,4,4 v 24 a4,4,0,0,1,-4,4 h -${length} c-2,0,-3,1,-4,2 l -4 4 c-1,1,-2,2,-4,2 h -12 c-2,0,-3,-1,-4,-2 l -4 -4 c-1,-1,-2,-2,-4,-2 h -8 a4,4,0,0,1,-4,-4z`;
		},
		height: 112,
	},
	"command-triple": {
		draw: (length = 108) => {
			return `M 0 4 a 4 4 0 0 1 4 -4 h 8 c 2 0 3 1 4 2 l 4 4 c 1 1 2 2 4 2 h 12 c 2 0 3 -1 4 -2 l 4 -4 c 1 -1 2 -2 4 -2 h ${length} a 4 4 0 0 1 4 4 l 0 40 a 4 4 0 0 1 -4 4 h -${
				length - 16
			} c -2 0 -3 1 -4 2 l -4 4 c -1 1 -2 2 -4 2 h -12 c -2 0 -3 -1 -4 -2 l -4 -4 c -1 -1 -2 -2 -4 -2 l -8 0 a 4 4 0 0 0 -4 4 l 0 16 a 4 4 0 0 0 4 4 l 8 0 c 2 0 3 1 4 2 l 4 4 c 1 1 2 2 4 2 h 12 c 2 0 3 -1 4 -2 l 4 -4 c 1 -1 2 -2 4 -2 h ${
				length - 16
			} a 4 4 0 0 1 4 4 l 0 24 a 4 4 0 0 1 -4 4 h -${
				length - 16
			} c -2 0 -3 1 -4 2 l -4 4 c -1 1 -2 2 -4 2 h -12 c -2 0 -3 -1 -4 -2 l -4 -4 c -1 -1 -2 -2 -4 -2 h -8 a 4 4 0 0 0 -4 4 v 16 a 4 4 0 0 0 4 4 l 8 0 c 2 0 3 1 4 2 l 4 4 c 1 1 2 2 4 2 h 12 c 2 0 3 -1 4 -2 l 4 -4 c 1 -1 2 -2 4 -2 h ${
				length - 16
			} a 4 4 0 0 1 4 4 l 0 24 a 4 4 0 0 1 -4 4 h -${length} c -2 0 -3 1 -4 2 l -4 4 c -1 1 -2 2 -4 2 h -12 c -2 0 -3 -1 -4 -2 l -4 -4 c -1 -1 -2 -2 -4 -2 l -8 0 a 4 4 0 0 1 -4 -4 Z`;
		},
		height: 168,
	},
};
