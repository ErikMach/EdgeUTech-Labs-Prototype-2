import {Scene, Color, PerspectiveCamera, AmbientLight, DirectionalLight, WebGLRenderer, sRGBEncoding, LinearToneMapping} from "./THREEm/three.module.js";
...
const loadGLTF = (dirs = [], func) => {
  ...
  dirs.forEach(dir => {
    loader.load(dir,
      function(glb) {
	if (!scene) {console.warn("Need to init before loading objects");};
